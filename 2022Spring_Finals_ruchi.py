...
if __name__ == '__main__':
    airplane_objects_dict1 = {}
    airplane_objects_dict2 = {}
    ...
    for i in range(1, 10001):
        ...
        airplane_objects_dict1[name] = airplane_attributes(weather_decider, wind_decider, weight_decider, ground_traffic_decider, "hyp_1")
        if i > 1:
            airplane_name_1 = 'airplane_{}'.format(i - 1)
            airplane_name_2 = 'airplane_{}'.format(i)
            a = airplane_objects_dict1[airplane_name_1].__dict__
            b = airplane_objects_dict1[airplane_name_2].__dict__
            #print(a)
    ...
    # for keys, values in airplane_objects_dict1.items():
    #     print(keys,values)
    ...
    for i in range(1, 10001):
     name = 'airplane_{}'.format(i)
     airplane_objects_dict2[name] = airplane_attributes(weather_decider, wind_decider, weight_decider, ground_traffic_decider, "hyp_2")
     if i > 1:
         airplane_name_1 = 'airplane_{}'.format(i - 1)
         airplane_name_2 = 'airplane_{}'.format(i)
         a = airplane_objects_dict2[airplane_name_1].__dict__
         b = airplane_objects_dict2[airplane_name_2].__dict__
         #print(a)
